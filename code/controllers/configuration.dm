...
//	var/enable_authentication = 0		// goon authentication
	...
	var/list/contact_levels = list(1,2,4,5,6)			// Defines which Z-levels which, for example, a Code Red announcement may affect
	var/list/player_levels = list(1,2, 4, 5, 6,7)	// Defines all Z-levels a character can typically reach
