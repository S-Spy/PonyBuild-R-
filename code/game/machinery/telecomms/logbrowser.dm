...
/obj/machinery/computer/telecomms/server
	...
	var/universal_translate = 0 // set to 1 if it can translate nonpony speech
			...
			if(1)
				...
				for(var/datum/comm_log_entry/C in SelectedServer.log_entries)
					...
					if(C.input_type == "Speech File")
						...
						// -- If the orator is a pony, or universal translate is active, OR mob has universal speech on --
						...
						// -- Orator is not pony and universal translate not active --
