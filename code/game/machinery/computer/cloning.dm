...
/obj/machinery/computer/cloning/proc/scan_mob(mob/living/carbon/pony/subject as mob)
	if ((isnull(subject)) || (!(ispony(subject))) || (!subject.dna))
		scantemp = "Error: Unable to locate valid genetic data."
		return
	if (!subject.has_brain())
		if(istype(subject, /mob/living/carbon/pony))
			var/mob/living/carbon/pony/H = subject
