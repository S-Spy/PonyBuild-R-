...
/obj/machinery/wish_granter/attack_hand(var/mob/user as mob)
	...
	if(charges <= 0)
		...
		user << "You speak.  [pick("I want the station to disappear","ponyity is corrupt, mankind must be destroyed","I want to be rich", "I want to rule the world","I want immortality.")].  The Wish Granter answers."
