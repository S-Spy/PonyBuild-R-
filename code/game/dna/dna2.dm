...
/datum/dna/proc/ResetUIFrom(var/mob/living/carbon/pony/character)
	// INITIALIZE!
	ResetUI(1)
	// Hair
...
/datum/dna/proc/check_integrity(var/mob/living/carbon/pony/character)
	if(character)
...
/datum/dna/proc/ready_dna(mob/living/carbon/pony/character)
	ResetUIFrom(character)
