...
/datum/dna/gene/monkey/can_activate(var/mob/M,var/flags)
	return istype(M, /mob/living/carbon/pony) || istype(M,/mob/living/carbon/monkey)
...
/datum/dna/gene/monkey/deactivate(var/mob/living/M, var/connected, var/flags)
	if(!istype(M,/mob/living/carbon/monkey))
		//testing("Cannot ponyize [M], type is [M.type].")
		return
	...
	if(M.mind)
		M.mind.transfer_to(O)	//transfer our mind to the pony
