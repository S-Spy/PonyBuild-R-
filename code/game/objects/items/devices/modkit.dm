...
/obj/item/device/modkit/pegasus
	name = "pegasus hardsuit modification kit"
	desc = "A kit containing all the needed tools and parts to modify a hardsuit for another user. This one looks like it's meant for Pegasus."
	target_species = "Pegasus"
