/obj/item/robot_parts/attack(mob/living/carbon/pony/M as mob, mob/living/carbon/user as mob)
	var/limbloc = null
	...
	if((user.zone_sel.selecting.name == "l_arm") && (istype(src, /obj/item/robot_parts/l_arm)))
		limbloc = "l_hand"
	else if((user.zone_sel.selecting.name == "r_arm") && (istype(src, /obj/item/robot_parts/r_arm)))
		limbloc = "r_hand"
	else if((user.zone_sel.selecting.name == "r_leg") && (istype(src, /obj/item/robot_parts/r_leg)))
		limbloc = "r_foot"
	else if((user.zone_sel.selecting.name == "l_leg") && (istype(src, /obj/item/robot_parts/l_leg)))
		limbloc = "l_foot"
	else
	...
	var/datum/organ/external/S = H.organs[user.zone_sel.selecting.name]
