...
/datum/faction/syndicate/Cybersun_Industries
	...
	desc = "<b>Cybersun Industries</b> is a well-known organization that bases its business model primarily on the research and development of pony-enhancing computer \
...
/datum/faction/syndicate/SELF
	...
	desc = "The <b>S.E.L.F.</b> (Sentience-Enabled Life Forms) organization is a collection of malfunctioning or corrupt artificial intelligences seeking to liberate silicon-based life from the tyranny of \
			their pony overlords. While they may not openly be trying to kill all ponys, even their most miniscule of actions are all part of a calculated plan to \
...
/datum/faction/syndicate/ARC
	...
	desc = "The <b>Animal Rights Consortium</b> is a bizarre reincarnation of the ancient Earth-based PETA, which focused on the equal rights of animals and nonpony biologicals. They have \
...
/datum/faction/Wizard
	...
	desc = "The <b>Wizards Federation</b> is a mysterious organization of magically-talented individuals who act as an equal collective, and have no heirarchy. It is unknown how the wizards \
			...
			individuals in the known universe, and have been labeled threats to ponyity by most governments. As such, they are enemies of both Nanotrasen and the Syndicate."
...
/datum/faction/Exolitics
	...
	desc = "The <b>Exolitics</b> are an ancient alien race with an energy-based anatomy. Their culture, communication, morales and knowledge is unknown. They are so radically different to ponys that their \
