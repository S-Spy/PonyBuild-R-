...
datum/game_mode/mutiny
	...
	proc/equip_head_loyalist()
		equip_head(head_loyalist, "loyalist", /mob/living/carbon/pony/proc/recruit_loyalist)

	proc/equip_head_mutineer()
		equip_head(head_mutineer, "mutineer", /mob/living/carbon/pony/proc/recruit_mutineer)

	proc/equip_head(datum/mind/head, faction, proc/recruitment_verb)
		var/mob/living/carbon/pony/H = head.current
...
/mob/living/carbon/pony/proc/recruit_loyalist()
	...
	var/mob/living/carbon/pony/M = input("Select a person to recruit", "Loyalist recruitment", null) as mob in candidates
...
/mob/living/carbon/pony/proc/recruit_mutineer()
	...
	var/mob/living/carbon/pony/M = input("Select a person to recruit", "Mutineer recruitment", null) as mob in candidates
