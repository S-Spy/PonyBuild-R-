...
/datum/news_announcement
	...
	revolution_inciting_event
		...
		pony_experiments
			round_time = 60*90
			message = {"Unbelievable reports about pony experimentation have reached our ears. According
			 			...
			 			on live ponys, including virology research, genetic manipulation, and \"feeding them
			 			to the slimes to see what happens\". Allegedly, these test subjects were neither
			 			ponyified monkeys nor volunteers, but rather unqualified staff that were forced into
	...
	random_junk
		...
		net_block
			author = "Assistant Editor Carl Ritz"
			channel_name = "The Gibson Gazette"
			message = {"Several corporations banding together to block access to 'wetalicorn.nt', site administrators
