...
/obj/vehicle/proc/insert_cell(var/obj/item/weapon/cell/C, var/mob/living/carbon/pony/H)
	if(cell)
		return
	if(!istype(C))
		return
...
/obj/vehicle/proc/remove_cell(var/mob/living/carbon/pony/H)
	if(!cell)
		return
...
/obj/vehicle/proc/RunOver(var/mob/living/carbon/pony/H)
