...
/obj/item/clothing/accessory/stethoscope/fluff/lucystethos
   ...
   desc = "A medical apparatus intended to ease in listening to the sounds of the pony body. This one looks cleaner and sparklier than the rest. There is a small silver plaque attached to the tubing, with the words 'Lucy Kemmerer' engraved on it."
...
/obj/item/fluff/ana_issek_2/attack(mob/living/carbon/pony/M, mob/living/user)
	if(isliving(user))
...
/obj/item/clothing/gloves/fluff/murad_hassim_1
	name = "Pegasus Surgical Gloves"
	desc = "Reinforced sterile gloves custom tailored to comfortably accommodate Pegasus claws."
	icon_state = "latex"
	item_state = "lgloves"
	siemens_coefficient = 0.30
	permeability_coefficient = 0.01
	item_color="white"
	species_restricted = list("exclude","Unicorn")
...
/obj/item/clothing/head/helmet/fluff/adapted
	name = "Adapted helmet"
	desc = "Standard Security gear. Protects the head from impacts. This helmet is specially made for horned Unicorn."
...
/obj/item/clothing/suit/fluff/oldscarf //Writerer2: Javaria Zara
	...
	icon_state = "mantle-unicorn"
	item_state = "mantle-unicorn"
	body_parts_covered = 0
...
/obj/item/clothing/suit/fluff/b_dress
	name = "Blue dress"
	desc = "A blue dress, worn with a white blouse. It is small, and looks like it won't fit a full grown pony."
	icon = 'icons/obj/custom_items.dmi'
	icon_state = "br_dress"
	item_state = "br_dress"
...
/obj/item/clothing/accessory/fluff/altair_locket
	name = "small locket"
	desc = "A small golden locket attached to an Ii'rka-reed string. Inside the locket is a holo-picture of a female Pegasus, and an inscription writtin in Siik'mas."
	icon = 'icons/obj/custom_items.dmi'
...
/obj/item/clothing/accessory/fluff/nasir_khayyam_1
	name = "medallion"
	desc = "This silvered medallion bears the symbol of the Hadii Clan of the Pegasus."
	icon = 'icons/obj/custom_items.dmi'
...
/mob/living/simple_animal/cat/fluff/bones/handle_movement_target()
	if (!friend)
		for (var/mob/living/carbon/pony/M in player_list)
