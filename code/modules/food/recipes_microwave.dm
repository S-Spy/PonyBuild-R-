...
/datum/recipe/ponyburger
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/meat/pony,
		/obj/item/weapon/reagent_containers/food/snacks/bun
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/pony/burger

/datum/recipe/plainburger
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/bun,
		/obj/item/weapon/reagent_containers/food/snacks/meat //do not place this recipe before /datum/recipe/ponyburger
	)
...
/datum/recipe/ponykabob
	items = list(
		/obj/item/stack/rods,
		/obj/item/weapon/reagent_containers/food/snacks/meat/pony,
		/obj/item/weapon/reagent_containers/food/snacks/meat/pony,
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/pony/kabob
