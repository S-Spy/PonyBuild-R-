...
/obj/item/weapon/book/manual/anomaly_testing
	...
	dat = {"<html>
				...
				is no species that could possibly match ponyity in it's achievements and knowledge, or simply that employing non-pony technology is dangerous and unethical.
