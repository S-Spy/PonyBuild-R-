...
//		command_alert("The station has entered an ion storm.  Monitor all electronic equipment for malfunctions", "Anomaly Alert")
	for (var/mob/living/carbon/pony/player in world)
		if(player.client)
	...
	var/list/laws = list(	"You are a mouse.",
							...
							"Monkeys are part of the crew, too. Make sure they are treated ponyely.",
...
*/
	...
	for(var/mob/living/silicon/ai/M in living_mob_list)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			var/allergy = pick("cotton", "uniforms", "acid", "oxygen", "pony contact", "cyborg contact", "medicine", "floors")
			var/allergysev = pick("deathly", "mildly", "severely", "contagiously")
			var/crew
			var/list/pos_crew = list()
			for(var/mob/living/carbon/pony/pos in player_list)
			...
			switch(rand(1,14))
				...
				if(2)
					M << "<br>"
					M << "\red [what2] ARE DANGEROUS TO ponyS...LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("[what2] ARE DANGEROUS TO ponyS")
				if(3)
					M << "<br>"
				...
				if(4)
					M << "<br>"
					M << "\red ponyS NEED TO EAT [what2pref] [what2] TO SURVIVE...LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("ponyS NEED TO EAT [what2pref] [what2] TO SURVIVE")
				if(5)
					M << "<br>"
				...
				if(12)
					M << "<br>"
					M << "\red YOU REQUIRE [require] IN ORDER TO PROTECT ponyS... LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("YOU REQUIRE [require] IN ORDER TO PROTECT ponyS")
				if(13)
					M << "<br>"
