	...
	if(useMS)
		if(prob(5))
			...
			switch(pick(1,2,3,4,5,6,7))
				...
				if(2)
					sender = pick(300;"QuickDatingSystem",200;"Find your russian bride",50;"Pegasus beauties are waiting",50;"Find your secret skrell crush",50;"Beautiful unicorn brides")
