...
/mob/living/carbon/pony/var/datum/reagents/vessel	//Container for blood and BLOOD ONLY. Do not transfer other chems here.
/mob/living/carbon/pony/var/var/pale = 0			//Should affect how mob sprite is drawn, but currently doesn't.

//Initializes blood vessels
/mob/living/carbon/pony/proc/make_blood()
...
//Resets blood data
/mob/living/carbon/pony/proc/fixblood()
...
/mob/living/carbon/pony/proc/handle_blood()
...
/mob/living/carbon/pony/proc/drip(var/amt as num)
...
//For ponys, blood does not appear from blue, it comes from vessels.
/mob/living/carbon/pony/take_blood(obj/item/weapon/reagent_containers/container, var/amount)
	...
	. = ..()
	vessel.remove_reagent("blood",amount) // Removes blood if pony
...
/mob/living/carbon/pony/inject_blood(obj/item/weapon/reagent_containers/container, var/amount)
...
proc/blood_splatter(var/target,var/datum/reagent/blood/source,var/large)
	...
	if(istype(source,/mob/living/carbon/pony))
		var/mob/living/carbon/pony/M = source
