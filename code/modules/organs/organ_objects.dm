...
/obj/item/organ/attack_self(mob/user as mob)
	...
	if(!robotic && user.a_intent == "help" && user.zone_sel.selecting.name == "mouth")
		bitten(user)
		return
...
/obj/item/organ/proc/removed(var/mob/living/carbon/pony/target,var/mob/living/user)
...
/obj/item/organ/proc/replaced(var/mob/living/carbon/pony/target,var/datum/organ/external/affected)
...
/obj/item/organ/eyes/replaced(var/mob/living/carbon/pony/target)
