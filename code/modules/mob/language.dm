...
/datum/language
	...
	var/key = "x"                    // Character used to speak in language eg. :o for Unicorn.
...
/datum/language/unicorn
	name = "Sinta'unicorn"
	desc = "The common language of Moghes, composed of sibilant hisses and rattles. Spoken natively by Unicorn."
	speech_verb = "hisses"
	ask_verb = "hisses"
	exclaim_verb = "roars"
	colour = "soghun"
...
/datum/language/unicorn/get_random_name()
...
/datum/language/pegasus
	name = "Siik'tajr"
	desc = "The traditionally employed tongue of Ahdomai, composed of expressive yowls and chirps. Native to the Pegasus."
	speech_verb = "mrowls"
	ask_verb = "mrowls"
	exclaim_verb = "yowls"
	colour = "Pegasus"
...
/datum/language/pegasus/get_random_name(var/gender)
...
/datum/language/pony/get_spoken_verb(var/msg_end)
	switch(msg_end)
		if("!")
			return pick("exclaims","shouts","yells") //TODO: make the basic proc handle lists of verbs.
		if("?")
...
/datum/language/pony/get_random_name(var/gender)
	if (prob(80))
		if(gender==FEMALE)
			return capitalize(pick(first_names_female)) + " " + capitalize(pick(last_names))
		else
...
/datum/language/binary
	name = "Robot Talk"
	desc = "Most pony stations support free-use communications protocols and routing hubs for synthetic use."
	colour = "say_quote"
	speech_verb = "states"
	ask_verb = "queries"
...
*/
/datum/language/pony/syllables = list(
