...
datum/skill/medical
    ID = "medical"
    name = "Medicine"
    desc = "Covers an understanding of the pony body and medicine. At a low level, this skill gives a basic understanding of applying common types of medicine, and a rough understanding of medical devices like the health analyzer. At a high level, this skill grants exact knowledge of all the medicine available on the station, as well as the ability to use complex medical devices like the body scanner or mass spectrometer."
    field = "Medical"

datum/skill/anatomy
    ID = "anatomy"
    name = "Anatomy"
    desc = "Gives you a detailed insight of the pony body. A high skill in this is required to perform surgery.This skill may also help in examining alien biology."
    field = "Medical"

datum/skill/virology
    ID = "virology"
    name = "Virology"
    desc = "This skill implies an understanding of microorganisms and their effects on ponys."
    field = "Medical"

datum/skill/genetics
    ID = "genetics"
    name = "Genetics"
    desc = "Implies an understanding of how DNA works and the structure of the pony DNA."
    field = "Science"

datum/skill/chemistry
	ID = "chemistry"
	name = "Chemistry"
	desc = "Experience with mixing chemicals, and an understanding of what the effect will be. This doesn't cover an understanding of the effect of chemicals on the pony body, as such the medical skill is also required for medical chemists."
	field = "Science"
...
mob/living/carbon/pony/proc/GetSkillClass(points)
	return CalculateSkillClass(points, age)

proc/show_skill_window(var/mob/user, var/mob/living/carbon/pony/M)
	if(!istype(M)) return
	if(SKILLS == null)
		setup_skills()
...
mob/living/carbon/pony/verb/show_skills()
	set category = "IC"
