...
/datum/medical_effect/proc/manifest(mob/living/carbon/pony/H)
	for(var/R in cures)
...
/datum/medical_effect/proc/on_life(mob/living/carbon/pony/H, strength)
	return

/datum/medical_effect/proc/cure(mob/living/carbon/pony/H)
	for(var/R in cures)
		if(H.reagents.has_reagent(R))
			if (cure_message)
				H <<"\blue [cure_message]"
...
// MOB HELPERS
// ===========
/mob/living/carbon/pony/var/list/datum/medical_effect/side_effects = list()
/mob/proc/add_side_effect(name, strength = 0)
/mob/living/carbon/pony/add_side_effect(name, strength = 0)
...
/mob/living/carbon/pony/proc/handle_medical_side_effects()
...
/datum/medical_effect/headache/on_life(mob/living/carbon/pony/H, strength)
	switch(strength)
		if(1 to 10)
...
/datum/medical_effect/bad_stomach/on_life(mob/living/carbon/pony/H, strength)
	switch(strength)
		if(1 to 10)
...
/datum/medical_effect/cramps/on_life(mob/living/carbon/pony/H, strength)
	switch(strength)
		if(1 to 10)
...
/datum/medical_effect/itch/on_life(mob/living/carbon/pony/H, strength)
	switch(strength)
		if(1 to 10)
