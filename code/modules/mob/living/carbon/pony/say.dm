/mob/living/carbon/pony/say(var/message)
...
/mob/living/carbon/pony/say_understands(var/mob/other,var/datum/language/speaking = null)
...
/mob/living/carbon/pony/GetVoice()
...
/mob/living/carbon/pony/proc/SetSpecialVoice(var/new_voice)
	if(new_voice)
		special_voice = new_voice
	return

/mob/living/carbon/pony/proc/UnsetSpecialVoice()
	special_voice = ""
	return

/mob/living/carbon/pony/proc/GetSpecialVoice()
...
/mob/living/carbon/pony/say_quote(var/message, var/datum/language/speaking = null)
	var/verb = "says"
	var/ending = copytext(message, length(message))
...
/mob/living/carbon/pony/proc/handle_speech_problems(var/message, var/verb = "says")
