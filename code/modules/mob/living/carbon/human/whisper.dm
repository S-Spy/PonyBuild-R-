//Lallander was here
/mob/living/carbon/pony/whisper(message as text)
	var/alt_name = ""
...
//This is used by both the whisper verb and pony/say() to handle whispering
/mob/living/carbon/pony/proc/whisper_say(var/message, var/datum/language/speaking = null, var/alt_name="", var/verb="whispers")
