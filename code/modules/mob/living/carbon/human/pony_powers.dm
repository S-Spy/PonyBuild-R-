// These should all be procs, you can add them to ponys/subspecies by
...
/mob/living/carbon/pony/proc/gut()
	...
	if(istype(G.affecting,/mob/living/carbon/pony))
		var/mob/living/carbon/pony/H = G.affecting
...
/mob/living/carbon/pony/proc/commune()
	set category = "Abilities"
...
/mob/living/carbon/pony/proc/psychic_whisper(mob/M as mob in oview())
