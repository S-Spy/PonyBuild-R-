...
/mob/living/simple_animal/borer/verb/infest()
	set category = "Abilities"
	set name = "Infest"
	set desc = "Infest a suitable ponyoid host."
...
/mob/living/simple_animal/borer/proc/replace_brain()
	...
	if(host.stat == 2)
		H.verbs |= /mob/living/carbon/pony/proc/jumpstart

	H.verbs |= /mob/living/carbon/pony/proc/psychic_whisper
	H.verbs |= /mob/living/carbon/pony/proc/tackle
...
/mob/living/carbon/pony/proc/jumpstart()
	set category = "Abilities"
	...
	verbs -= /mob/living/carbon/pony/proc/jumpstart
