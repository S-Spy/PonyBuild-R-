...
//	flags = NOREACT
	...
	The current method unnecessarily clusters up the variable list, especially for ponys (although rearranging won't really clean it up a lot but the difference will be noticable for other mobs).
	...
	*/
	...
	var/seer = 0 //for cult//Carbon, probably pony
