...
Общая система заклинаний:
  ...
  Трата сытности на старте - Ок
  Одновременно одно долгосрочное заклинание -
  Если горит рог и это не то же долгосрочное заклинание, то долгосрочнное заклинание не вызывается
  Если горит рог и активно другое недолгосрочное заклинание, то отказано
  Если рог не горит или , то записывается номер активированного долгосрочного заклинания
