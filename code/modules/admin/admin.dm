	...
	if (M.client)
		if(!istype(M, /mob/new_player))
			...
			body += {"<br><br>
				...
				<A href='?src=\ref[src];simplemake=pony;species=Xenomorph Drone;mob=\ref[M]'>Drone</A>
				<A href='?src=\ref[src];simplemake=pony;species=Xenomorph Hunter;mob=\ref[M]'>Hunter</A>
				<A href='?src=\ref[src];simplemake=pony;species=Xenomorph Sentinel;mob=\ref[M]'>Sentinel</A>
				<A href='?src=\ref[src];simplemake=pony;species=Xenomorph Queen;mob=\ref[M]'>Queen</A> \] |
