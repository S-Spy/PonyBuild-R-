			...
			if(66 to 70)
				...
				if(!halbody)
					...
					if(possible_points.len)
						...
						switch(rand(1,4))
							if(1)
								halbody = image('icons/mob/pony.dmi',target,"husk_l",TURF_LAYER)
							if(2,3)
								halbody = image('icons/mob/pony.dmi',target,"husk_s",TURF_LAYER)
							if(4)
...
/*obj/machinery/proc/mockpanel(list/buttons,start_txt,end_txt,list/mid_txts)
	...
	if(!mocktxt)
		...
		"Play Charades","Oxygen","Inject BeAcOs","Ninja pegasuss","Limit Break","Build Sentry")
...
proc/check_panel(mob/M)
	if (istype(M, /mob/living/carbon/pony) || istype(M, /mob/living/silicon/ai))
...
/obj/effect/fake_attacker
	...
	anchored = 1
	opacity = 0
	var/mob/living/carbon/pony/my_target = null
...
//	var/list/possible_clones = new/list()
	var/mob/living/carbon/pony/clone = null
