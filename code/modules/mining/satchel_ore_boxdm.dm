...
/obj/structure/ore_box/examine(mob/user)
	...
	if((!istype(user, /mob/living/carbon/pony)) && (!istype(user, /mob/living/silicon/robot)))
		return
...
/obj/structure/ore_box/verb/empty_box()
	...
	if(!istype(usr, /mob/living/carbon/pony)) //Only living, intelligent creatures with hands can empty ore boxes.
