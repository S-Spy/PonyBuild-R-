...
/obj/item/clothing/accessory/stethoscope
	name = "stethoscope"
	desc = "An outdated medical apparatus for listening to the sounds of the pony body. It also makes you look like you know what you're doing."
...
/obj/item/clothing/accessory/holobadge/attack(mob/living/carbon/pony/M, mob/living/user)
	if(isliving(user))
