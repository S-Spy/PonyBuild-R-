...
/obj/item/device/detective_scanner/attack(mob/living/carbon/pony/M as mob, mob/user as mob)
	if (!ispony(M))
		user << "<span class='warning'>[M] is not pony and cannot have the fingerprints.</span>"
		flick("forensic0",src)
		return 0
