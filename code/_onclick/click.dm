...
/*
	...
	is recieving it.
	The most common are:
	* mob/UnarmedAttack(atom,adjacent) - used here only when adjacent, with no item in hand; in the case of ponys, checks gloves
...
/*
	...
	in pony click code to allow glove touches only at melee range.
*/
...
/mob/living/carbon/pony/MiddleClickOn(var/atom/A)
...
/mob/living/carbon/pony/LaserEyes()
	if(nutrition>0)
		..()
