...
/datum/hud/proc/instantiate()
	...
	if(ispony(mymob))
		pony_hud(ui_style, ui_color, ui_alpha, mymob) // Pass the player the UI style chosen in preferences
...
/mob/verb/button_pressed_F12(var/full = 0 as null)
	...
	if(!ispony(src))
		usr << "\red Inventory hiding is currently only supported for pony mobs, sorry."
		return
