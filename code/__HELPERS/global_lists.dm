...
var/global/list/whitelisted_species = list("Earthpony") // Species that require a whitelist check.
var/global/list/playable_species = list("Earthpony")    // A list of ALL playable species, whitelisted, latejoin or otherwise.
